...
export const CATEGORIES: PlanCategory[] = [
    ...
    items: [
      {
        ...
        emailBody:
          "Hi Minh,\n\nI just moved to the area with my family. I heard you're also from Vietnam and live nearby \u2014 I'd love to meet up for a coffee or chat sometime.\n\nLooking forward to connecting!",
      },
      {
        label: 'Sarah Chen',
        ...
        emailBody:
          "Hi Sarah,\n\nMy kids are starting at Westfield Primary soon and I'd love to connect with other parents. Would you have time for a quick chat about the school?\n\nThanks!",
      },
      {
        label: 'David Nguyen',
        detail: 'Runs Vietnamese Families Melbourne group',
        email: 'david.nguyen@email.com',
        emailSubject: 'Interested in Vietnamese Families Melbourne',
        emailBody:
          "Hi David,\n\nI recently moved to Melbourne with my family and came across your Vietnamese Families Melbourne group. We'd love to join and meet other families.\n\nCould you let us know how to get involved?\n\nThanks!",
      },
      {
        label: 'Priya Sharma',
      ...
      },
      {
        ...
        emailBody:
          "Hi Tom,\n\nI'm new to the neighbourhood and heard you volunteer with the local welcome program. I'd love to learn more about the area and any tips for settling in.\n\nThanks for what you do!",
      },
    ],
  },
  {
    ...
    items: [
      ...
      {
        label: 'Westfield Primary Open Morning',
        detail:
        ...
        location: 'Westfield Primary School',
      },
      {
  ...
  },
  {
    ...
    items: [
      {
        label: 'Vietnamese Families Melbourne',
        detail: '320 members \u2022 Very active',
        platform: 'Facebook Group',
        groupUrl: 'https://www.facebook.com/groups/',
      },
      {
        label: 'Westfield School Parents',
      ...
      {
        label: 'Local Sports & Play',
        detail: '156 members \u2022 Kids activities',
        platform: 'Facebook Group',
        groupUrl: 'https://www.facebook.com/groups/',
      },
    ],
